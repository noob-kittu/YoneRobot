...
PM_START_TEXT = """
Hellow [🤗](https://telegra.ph/file/29dc600f7ce24cb852e57.jpg), I m sparrow a highly advanced bot with lots of features.
'I m here to manage ur groups'
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ show me ur place ➕️", url="http://t.me/pyrates_Xrobotstartgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [sparrow🙋‍♀️](https://telegra.ph/file/082096b101615e33eaf19.jpg) 
    ...
    if query.data == "sparrow_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="pyrates_back")
                 ]
                ]
            ),
        )
