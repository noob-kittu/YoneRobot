...
FLOOD_BAN_HANDLER = MessageHandler(
    Filters.all & ~Filters.status_update & Filters.chat_type.group, check_flood, run_async=True
)
SET_FLOOD_HANDLER = CommandHandler("setflood", set_flood, filters=Filters.chat_type.group, run_async=True)
...
FLOOD_HANDLER = CommandHandler("flood", flood, filters=Filters.chat_type.group, run_async=True)
